    ...
    <div class="page-wrapper">
        <div class="container-fluid content">
            <div class="page-header">
                <div class="row">
                    <div-col>
                        <h3 class="page-title">User Builder</h3>
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item"><a href="dashboard.php">Dashboard</a></li>
                            <li class="breadcrumb-item-active">User Builder</li>
                        </ul>
                    </div-col>
                </div>
            </div>
                ...
                <div class="col-sm-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title text-center">User builder list</h4>
                            <?php
                                if(isset($_GET['msg'])) {
                                    echo $_GET['msg'];
                                }
                            ...
                            <table class="table" id="basic-datatable">
                                ...
                                <tbody>
                                    ...
                                    <tr class="text-center">
                                        ...
                                        <td><a href="userbuilderdelete.php?id=<?=$row['0'];?>"><i class="fa fa-trash"></i></a></td>
                                    </tr>
                                    <?php
                                        }
                                    ?>
