...
<?php include("include/header.php");?>
  ...
  <!-- faire le systeme d'authentification + jquery validates pour le register & le Login-->
  <!-- créer la partie register avec les mots de passe cryptés (jQuery validate si possible en plus) -->
